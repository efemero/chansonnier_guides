...
\cover     {resources/trefles_front.png}{resources/trefles_back.png}
\author    {}
...
\begin{minipage}[t][0.5\textheight][t]{\textwidth}
\vspace{0.00\textheight}
\h*{Chevaliers de la table ronde}
\begin{multicols}{2}
...
\begin{bfseries}
[Refrain:]\\
Je Veux d'l'amour, d'la joie, de la bonne humeur, ce n'est pas votre argent qui f'ra mon bonheur, \\
moi j'veux crever la main sur le cœur papalapapapala allons ensemble, découvrir ma liberté, oubliez donc tous vos clichés, bienvenue dans ma réalité. \\
\end{bfseries}
