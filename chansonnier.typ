...
Il y a des ruisseaux, des clairières, pas de quoi en faire un plat de ce
coin \
...
#strong[\[Répétition 1\] \[Répétition 3\]]
]
...
+ Crayon gris, crayon gris, Dieu dessine la pluie \
  Crayon d’or, crayon d’or, Dieu dessine le soleil \

+ Crayon brun, crayon brun, Dieu dessine la terre \
  Crayon roux, crayon roux, Dieu dessine le feu \

+ Crayon vert, crayon vert, Dieu dessine la mer \
  Crayon nid, crayon nid, Dieu dessine un oiseau \

+ Crayon blanc, crayon blanc, Dieu dessine un enfant \
...
= Un petit gamin
<un-petit-gamin>
+ Un petit gamin, à la mine légère \
...
+ e garde champêtre, caché derrière un arbre, \
  Envoi son chien comme après un voleur. \
  Le chien l’attrape par le fond de la culotte, \
  En chemin, il se mit à crier \
  #strong[\[Refrain\]: Aïe…] \

+ Le lendemain, à l’école du village, Le maître lui dit : te voilà bien
  puni, A l’avenir, promets-moi d’être sage, Et chante en chœur avec
  tous tes amis :

  #strong[\[Refrain\]: Oh la…] \
  #strong[\[Refrain\]: Miam…] \
  #strong[\[Refrain\]: Aïe…]
...
#columns(2, gutter: 8pt)[
#box(stroke:black, inset:0.25em, width: 100%)[
= As-tu vu la vache?
<as-tu-vu-la-vache>
...
= Le Roi Lion : Le cycle de la vie
<le-roi-lion-le-cycle-de-la-vie>
...
<la-belle-et-la-bête-cest-la-fête>
#columns(2, gutter: 8pt)[
...
*_\[Mowgli\]_* Aïe! \
*_\[Baloo\]_* Mais c’est tout un drame \
Si c’est un cactus \
...
Il en faut vraiment peu, \
Très peu, pour être heureux! \
*_\[Mowgli\]_* Pour être heureux? \
Pour être heureux! \
*_\[Baloo\]_* Et tu verras qu’ tout est résolu \
Lorsque l’on se passe \
Des choses superflues \
Alors tu ne t’en fais plus. \
Il en faut vraiment peu, très peu, pour être heureux. \
*_\[Baloo & Mowgli\]_* Il en faut peu pour être heureux \
Vraiment très peu pour être heureux \
...
<lhorloge-tourne-mickael-miro>
Un sms vient d’arriver, j’ai 18 ans, envolée ma virginité, j’suis plus
un enfant. L’horloge tourne, les minutes sont torrides et moi je rêve
...
= L’assasymphonie (Opera Rock Mozart)
<lassasymphonie-opera-rock-mozart>
...
= Marc Lavoine – Elle a les yeux révolvers
<marc-lavoine-elle-a-les-yeux-révolvers>
#columns(2, gutter: 8pt)[
Un peu spéciale, elle est célibataire \
Le visage pâle, les cheveux en arrière \
...
<céline-dion-et-jean-jacques-goldman-jirai-où-tu-iras>
#columns(2, gutter: 8pt)[
...
Tes nord et puis tes sud et tes est et tes zestes d’ouest \
